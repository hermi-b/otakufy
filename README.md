...
The repository structure is shown expanded below (do not collapse). This lists required folders and key JavaScript scripts:
...
+-- kuromoji.js
|
+-- dict/                  # Required Kuromoji dictionary files (must be included)
|   +-- base.dat
|   +-- cc.dat
|   +-- ... (other dict files)
|
...
5. Select the folder containing this project (otakufy/).
...
When you visit https://open.spotify.com, the extension’s content-script.js runs automatically.
...
2. Play a song containing Japanese lyrics
3. Open the lyrics view
